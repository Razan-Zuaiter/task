...
<head>
    ...
    <link
        href="{{asset('vendor/font-awesome-4.7/css/font-awesome.min.css')}}"
        rel="stylesheet"
        media="all"
    />
    <link
        href="{{asset('vendor/font-awesome-5/css/fontawesome-all.min.css')}}"
        rel="stylesheet"
        media="all"
    />
    <link
        href="{{asset('vendor/mdi-font/css/material-design-iconic-font.min.css')}}"
        rel="stylesheet"
        media="all"
    />
    ...
    <!-- Bootstrap CSS-->
    <link
        href="{{asset('vendor/bootstrap-4.1/bootstrap.min.css')}}"
        rel="stylesheet"
        media="all"
    />
    ...
    <!-- Vendor CSS-->
    <link
        href="{{asset('vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css')}}"
        rel="stylesheet"
        media="all"
    />
                        ...
                        <div class="header-button">
                            <div class="noti-wrap">
                                <div class="noti__item js-item-menu">
                                    <i
                                        class="zmdi zmdi-comment-more"
                                    ></i>
                                    <span class="quantity">1</span>
                                    <div
                                        class="mess-dropdown js-dropdown"
                                    >
                                        ...
                                        <div class="mess__item">
                                            ...
                                            >
                                                <img
                                                    src="{{asset('images/icon/avatar-06.jpg')}}"
                                                    alt="Michelle Moreno"
                                                />
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="mess__item">
                                            ...
                                            >
                                                <img
                                                    src="{{asset('images/icon/avatar-04.jpg')}}"
                                                    alt="Diane Myers"
                                                />
                                            </div>
                                            <div class="content">
                                ...
                                <div class="noti__item js-item-menu">
                                    ...
                                    <span class="quantity">1</span>
                                    <div
                                        class="email-dropdown js-dropdown"
                                    >
                                        ...
                                        <div class="email__item">
                                            ...
                                            >
                                                <img
                                                    src="{{asset('images/icon/avatar-05.jpg')}}"
                                                    alt="Cynthia Harvey"
                                                />
                                            </div>
                                            <div class="content">
                                ...
                                <div class="noti__item js-item-menu">
                                    ...
                                    <div
                                        class="notifi-dropdown js-dropdown"
                                    >
                                        ...
                                        <div class="notifi__item">
                                            <div
                                                class="bg-c3 img-cir img-40"
                                            >
                                                <i
                                                    class="zmdi zmdi-file-text"
                                                ></i>
                                            </div>
                                            <div class="content">
                                                <p>
